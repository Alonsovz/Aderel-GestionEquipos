...
class DaoEgresos extends DaoBase {
    ...
    $_query = "call registrarEgreso('".$this->objeto->getChNo()."', '".$this->objeto->getConceptoEgreso()."',
    '".$this->objeto->getCantidad()."', '".$this->objeto->getRetencion()."', '".$this->objeto->getPagado()."', '".$this->objeto->getMes()."'
    , '".$this->objeto->getAnio()."',1)";
    ...
    public function editar() {
        ...
        '".$this->objeto->getCantidad()."', '".$this->objeto->getRetencion()."', ".$this->objeto->getPagado().",".$this->objeto->getIdEgreso().")";
