...
class Reporte {
    ...
    public function reporteDiario($total,$resultado1,$mostrar,$cantidad,$pagado,$retencion) {
        ...
        $tabla.= "
            ...
            <th style='border: 1px solid white; font-size:22px;'>
                <font color='#172961'>Reporte diario de Egresos de la fecha:</font> <font color='#BA9B1E'>".$validar."
                </font>
            </th>
