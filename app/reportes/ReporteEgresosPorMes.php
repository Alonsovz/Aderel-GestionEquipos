...
class Reporte {
    ...
    public function reporteEgresosPorMes($mes,$anio, $resultado, $resultado1,$cantidad,$retencion,$pagado) {
        $nombreMes ="";
        if($mes == "01"){
            $nombreMes = "Enero";
        }
        ...
        $tabla.= "
            ...
            <th style='border: 1px solid white; font-size:22px;'>
                <font color='#172961'>Reporte de Egresos del mes:</font> <font color='#BA9B1E'>".$nombreMes." ".$anio."
                </font>
            </th>
