     ...
     <div class="field" >
         ...
         <div class="twelve wide field"></div>                
            <div class="two wide field">
                <a style="width: 100%;"  class="ui right floated pink  inverted segment" onclick="cargarContenidoCF()" id="btnVerF">
            ...
            <div class="two wide field">
                <a style="width: 100%;" class="ui right floated teal  inverted segment"  onclick="cargarContenidoCM()" id="btnVerM">
...
function cargarContenidoCM()
{
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            $("#contenidoCategoria").append(response);
        }
    });
    
}

function cargarContenidoCF()
{
