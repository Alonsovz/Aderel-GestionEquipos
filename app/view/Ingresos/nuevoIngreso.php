...
<div class="row"  id="dashboard-card-egreso">
    ...
    <a class="ui blue inverted segment" style="width: 20%; text-align:center; font-size: 22px;"
    href="?1=EgresosController&2=Egresos">
    <i class="money bill icon"></i>
    Egreso por cheque
    </a> 

    <a class="ui yellow inverted segment" style="width: 20%; text-align:center; font-size: 22px;"
    ...
    <a class="ui blue inverted segment" style="width: 28%; text-align:center; font-size: 22px;"
    href="?1=EgresosController&2=reintegroCajaG">
    <i class="dollar icon"></i>
    Reintegro caja general
    </a>

    <a class="ui yellow inverted segment" style="width: 28%; text-align:center; font-size: 22px;"
