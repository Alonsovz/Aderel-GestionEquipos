...
<div class="row"  id="dashboard-card-egreso">
    ...
    <a class="ui blue inverted segment" style="width: 32%; text-align:center; font-size: 22px;"
    ...
    <a class="ui yellow inverted segment" style="width: 32%; text-align:center; font-size: 22px;"
