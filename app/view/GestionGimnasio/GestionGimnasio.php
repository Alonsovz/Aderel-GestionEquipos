<br><div id="app">
    ...
    <modal-eliminar id_form="frmEliminar" id="modalEliminar" url="?1=GimnasioController&2=eliminar" titulo="Eliminar Usuario de Gimnasio"
        ...
        <modal-eliminar id_form="frmEliminar" id="modalInscribir" url="?1=GimnasioController&2=reinscribir" 
        titulo="Reeinscribir Usuario del Gimnasio"
        sub_titulo="¿Está seguro de querer reeinscribir este usuario?" :campos="campos_eliminar" tamanio='tiny'></modal-eliminar>
