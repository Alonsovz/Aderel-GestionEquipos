...
<head>
    ...
    <title>Aderel | Finanzas</title>


    <!-- Favicon -->
    <link rel="icon" type="image/png" href="./res/img/logoaderel.png">
    ...
    <script src="./res/plugins/Calendar/js/moment.min.js"></script>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/3.10.0/fullcalendar.min.css">
    <script src="./res/plugins/Calendar/js/fullcalendar.min.js"></script>
    <script src="./res/plugins/Calendar/js/es.js"></script>
