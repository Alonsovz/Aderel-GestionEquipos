            ...
            <div class="cuadro" style="min-width: 350px;border: 3px solid #08088A;">
                ...
                <form id="frmNewPass" action="" method="POST" class="ui form">
                    ...
                    <a id="label-error" style="display: none; margin: 0; text-align:center;" class="ui red fluid large label"
                        v-if="isError">Datos
                        Incorrectos</a>
                    <button style="margin-top: 15px;" class="ui yellow fluid button" name="btnEnviar" value="noloc"
                        @click="login" id="btnEnviar" type="button" @submit.prevent="">Restablecer contraseña</button>
