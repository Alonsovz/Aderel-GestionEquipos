...
<!-- modal de registro -->
        ...
        <div class="ui grid">
            <div class="row">
                ...
                Mi cuenta ADEREL<font color="#85BC22" size="20px">.</font></h1><hr>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="eight wide column">
                    <h3 class="ui header"><font color=""><i class="user outline icon"></font></i>Usuario ADEREL<font color="#85BC22" size="20px">.</font></h3>
                ...
                <center><h3><i class="cogs icon"></i> Opciones de configuración.</h3></center>
                    <div class="ui list">
                    <div class="item">
                            <button class="ui right floated fluid yellow button" id="btnCambiarNomUser" type="button"><i class="user icon"></i>Usuario</button>
                        </div>
                        <div class="item">
                            <button class="ui right floated fluid blue  button" id="btnCambiarNom" type="button"><i class="street view icon"></i>Datos Personales</button>
                        </div>
                        <div class="item">
                            <button class="ui right floated fluid yellow button" id="btnCambiarContra" type="button"><i class="lock icon"></i>Modificar contraseña</button>
                        </div>
