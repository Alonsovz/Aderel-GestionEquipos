<br><div id="app">
    ...
    <modal-eliminar id_form="frmEliminar" id="modalEliminar" url="?1=EscFutbolController&2=eliminarPrimerN"
     titulo="Eliminar Jugador de quinto nivel" sub_titulo="¿Está seguro de querer eliminar este usuario?"
      ...
      <modal-reinscribir id_form="frmEliminar" id="modalInscribir" url="?1=EscFutbolController&2=reinscribir" 
        ...
        <div class="row">
                ...
                <i class="futbol icon"></i><i class="university icon"></i>
                    5to Nivel Escuela de futbol Aderel (14-15 años)<font color="#04B4AE" size="20px">.</font>
                    ...
                    <a href="?1=EscFutbolController&2=quinto" style="color:black;">
        ...
        <div class="row title-bar">
            <div class="sixteen wide column">
                <button class="ui right floated olive labeled icon button" id="btnModalRegistroJugador">
                    <i class="plus icon"></i>
                    Agregar
                </button>
                <button class="ui right floated brown labeled icon button" id="btnGestion">
                    <i class="cogs icon"></i>
                    Gestion General
                </button>
            </div>
        ...
        <div class="row">
            <div class="sixteen wide column">
                <table id="dtQuintoN" class="ui selectable very compact celled table" style="width:100%; margin:auto;">
                    <thead>
                        <tr>
                        ...
                        <th style="background-color: #86B404; color:white;"></th>
                            ...
                            <th style="background-color: #86B404; color:white;">Fecha Nac</th>
                            <th style="background-color: #86B404; color:white;">Edad</th>
...
<div class="header">
<i class="male icon"></i><i class="futbol icon"></i> Agregar nuevo Jugador de Quinto Nivel (14-15 años)
</div>
<div class="content" class="ui equal width form">
                ...
                <div class="field">
                        <div class="fields">
                            ...
                            <div class="ui red pointing label"  id="validar"
                                        style="display: none; margin: 0; text-align:center; width:100%; font-size: 12px;">
                                        La edad del jugador no es apta para el nivel (14-15 años)</div>
                            </div>
                        </div>
                </div>
    ...
    <div class="header">
        <i class="futbol icon"></i>Gestión general del quinto nivel
    </div>
    <div class="content">
                ...
                <div class="field">
                        <div class="fields">
                                <div class="eight wide field">
                                    ...
                                    <option value="Miercoles y Jueves">Miércoles y Jueves</option>
                                    <option value="Miercoles y Viernes">Miércoles y Viernes</option>
...
<script src="./res/tablas/tablaQuintoN.js"></script>
...
$(document).ready(function(){
    ...
    $('#frmEditar input[name="error"]').css("display","none");
    $("#5").removeClass("ui olive button");
    $("#5").addClass("ui olive basic button");
});
...
$("#btnGuardarJugador").click(function(){
    ...
    const form = $('#frmJugador');
            ...
            $.ajax({
                ...
                cache: false,
                type: 'POST',
                url: '?1=EscFutbolController&2=guardarQuinto',
