      ...
      <modal-reinscribir id_form="frmEliminar" id="modalInscribir" url="?1=EscFutbolController&2=reinscribir" 
        ...
        <div class="row title-bar">
            <div class="sixteen wide column">
                <button class="ui right floated purple labeled icon button" id="btnModalRegistroJugador">
                    <i class="plus icon"></i>
                    Agregar
                </button>
        ...
        <div class="row">
            <div class="sixteen wide column">
                <table id="dtSextoN" class="ui selectable very compact celled table" style="width:100%; margin:auto;">
                    <thead>
                        <tr>
                        ...
                        <th style="background-color: #A901DB; color:white;"></th>
                            ...
                            <th style="background-color: #A901DB; color:white;">Fecha Nac</th>
...
<div class="header">
<i class="male icon"></i><i class="futbol icon"></i> Agregar nuevo Jugador de Sexto Nivel (16-17 años)
</div>
                ...
                <div class="field">
                        <div class="fields">
                            ...
                            <div class="ui red pointing label"  id="validar"
                                        style="display: none; margin: 0; text-align:center; width:100%; font-size: 12px;">
                                        La edad del jugador no es apta para el nivel (16-17 años)</div>
                            </div>
                        </div>
                </div>
...
$("#btnGuardarJugador").click(function(){
    ...
    const form = $('#frmJugador');
            ...
            $.ajax({
                ...
                cache: false,
                type: 'POST',
                url: '?1=EscFutbolController&2=guardarSexto',
                ...
                success: function(r) {
                    if(r == 1) {
                        ...
                        $('#dtSextoN').DataTable().ajax.reload();
                        cerrar();
                    } 
                }
            });
