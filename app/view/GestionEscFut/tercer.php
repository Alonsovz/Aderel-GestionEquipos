<br><div id="app">
    ...
    <modal-eliminar id_form="frmEliminar" id="modalEliminar" url="?1=EscFutbolController&2=eliminarPrimerN"
     titulo="Eliminar Jugador de tercer nivel" sub_titulo="¿Está seguro de querer eliminar este usuario?"
      ...
      <modal-reinscribir id_form="frmEliminar" id="modalInscribir" url="?1=EscFutbolController&2=reinscribir" 
        ...
        <div class="row">
                ...
                <i class="futbol icon"></i><i class="university icon"></i>
                    3er Nivel Escuela de futbol Aderel (10-11 años)<font color="#04B4AE" size="20px">.</font>
                    <br>
                    ...
                    <a href="?1=EscFutbolController&2=tercer" style="color:black;">
        ...
        <div class="row">
            <div class="sixteen wide column">
                <table id="dtTercerN" class="ui selectable very compact celled table" style="width:100%; margin:auto;">
                    <thead>
                        <tr>
                        
                        <th style="background-color: #04B4AE; color:white;">N°</th>
                        <th style="background-color: #FACC2E; color:white;"></th>
                            <th style="background-color: #FACC2E; color:white;">Cod. Expediente</th>
                            <th style="background-color: #FACC2E; color:white;">Nombres</th>
                            <th style="background-color: #FACC2E; color:white;">Apellido</th>
                            <th style="background-color: #FACC2E; color:white;">Fecha Nac</th>
                            <th style="background-color: #FACC2E; color:white;">Edad</th>
                            <th style="background-color: #FACC2E; color:white;">Carnet Min.</th>
                            <th style="background-color: #FACC2E; color:white;">Encargado</th>
                            <th style="background-color: #FACC2E; color:white;">Teléfono</th>
...
<div class="header">
<i class="male icon"></i><i class="futbol icon"></i> Agregar nuevo Jugador de Tercer Nivel (10-11 años)
</div>
...
<div class="ui modal" id="modalgestion">
    <div class="header">
        <i class="futbol icon"></i>Gestión general del tercer nivel
    </div>
    <div class="content">
...
<script src="./res/tablas/tablaTercerN.js"></script>
...
$(document).ready(function(){
    ...
    $('#frmEditar input[name="error"]').css("display","none");
    $("#3").removeClass("ui red button");
    $("#3").addClass("ui red basic button");
});
...
$("#btnGuardarJugador").click(function(){
    ...
    const form = $('#frmJugador');
            ...
            $.ajax({
                ...
                cache: false,
                type: 'POST',
                url: '?1=EscFutbolController&2=guardarTercero',
                ...
                success: function(r) {
                    if(r == 1) {
                        ...
                        $('#dtTercerN').DataTable().ajax.reload();
                        cerrar();
                    } 
                }
            });
...
var mover=(ele)=>{
    var id = $(ele).attr("id");
    alertify.confirm("¿Desea movel el jugador al cuarto nivel?",
            function(){
             $.ajax({
                type: 'POST',
                url: '?1=EscFutbolController&2=moverTercerN',
                data: {
                ...
                success: function(r) {
                    if(r == 1) {
                        swal({
                            title: 'Listo!',
                            text: 'Jugador ya es parte del cuarto nivel',
                            type: 'success',
                            showConfirmButton: false,
                                timer: 1700
