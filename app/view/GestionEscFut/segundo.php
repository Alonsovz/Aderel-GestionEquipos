<br><div id="app">
    ...
    <modal-eliminar id_form="frmEliminar" id="modalEliminar" url="?1=EscFutbolController&2=eliminarPrimerN"
     titulo="Eliminar Jugador de segundo nivel" sub_titulo="¿Está seguro de querer eliminar este usuario?"
      ...
      <modal-reinscribir id_form="frmEliminar" id="modalInscribir" url="?1=EscFutbolController&2=reinscribir" 
        ...
        <div class="row">
                ...
                <i class="futbol icon"></i><i class="university icon"></i>
                    ...
                    <a href="?1=EscFutbolController&2=segundo" style="color:black;">
                        2do Nivel (8-9 años)
                    </a>
                    </button>
        ...
        <div class="row title-bar">
            <div class="sixteen wide column">
                ...
                <button class="ui right floated red labeled icon button" id="btnGestion">
                    <i class="cogs icon"></i>
                    Gestion General
                </button>
            </div>
        ...
        <div class="row">
            ...
            <table id="dtSegundoN" class="ui selectable very compact celled table" style="width:100%; margin:auto;">
                    <thead>
                        ...
                        <th style="background-color: #217CD1; color:white;"></th>
                ...
                <div class="field">
                        <div class="fields">
                            ...
                            <div class="ui red pointing label"  id="validar"
                                        style="display: none; margin: 0; text-align:center; width:100%; font-size: 12px;">
                                        La edad del jugador no es apta para el nivel (8-9 años)</div>
                            </div>
                        </div>
                </div>
...
<div class="ui modal" id="modalgestion">
    <div class="header">
        <i class="futbol icon"></i>Gestión general del segundo nivel
    </div>
    <div class="content">
...
$(document).ready(function(){
    ...
    $('#frmEditar input[name="error"]').css("display","none");
    $("#2").removeClass("ui blue button");
    $("#2").addClass("ui blue basic button");
});
